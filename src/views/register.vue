  ...
  <div class="auth-page register-page">
    ...
    <div class="auth-shell">
      <div class="auth-card">
        ...
        <h1 class="intro-title">创建你的社团账户</h1>
        <p class="intro-desc">注册后即可收藏社团、参与活动报名、第一时间接收公告通知。</p>
        <div class="intro-metrics">
          <article class="metric-card">
            <span class="metric-value">100%</span>
            <span class="metric-label">学生身份使用</span>
          </article>
          <article class="metric-card">
            <span class="metric-value">1min</span>
            <span class="metric-label">快速完成注册</span>
          </article>
          <article class="metric-card">
            <span class="metric-value">实时</span>
            <span class="metric-label">消息通知</span>
          </article>
        </div>
        ...
        <div class="panel-head">
          ...
          <p class="panel-subtitle">创建账号后即可加入你喜欢的校园社团</p>
        </div>
        ...
        <el-form ref="registerRef" :model="registerForm" :rules="registerRules" class="auth-form">
          ...
          <el-form-item class="submit-item">
            <el-button :loading="loading" size="large" type="primary" @click.prevent="handleRegister">
